...
from causal_explainer.utils import tensor_imshow
...
class SFLVisualizer:
    def __init__(self):
        ...
        self.tensor_imshow = tensor_imshow
    ...
    def plot_saliency_map(self, img, saliency_map, target_class):
        from causal_explainer.utils import get_class_name
        ...
        plt.subplot(1, 2, 2)
        plt.axis('off')
        plt.title(f"Saliency Map for {get_class_name(target_class)}")
        self.tensor_imshow(img[0])
